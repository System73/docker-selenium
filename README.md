...
Opera
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-opera:3.141.59-yttrium
#OR
$ docker run -d -p 4444:4444 --shm-size=2g selenium/standalone-opera:3.141.59-yttrium
```
...
$ docker run -d --net grid -e HUB_HOST=selenium-hub -v /dev/shm:/dev/shm selenium/node-opera:3.141.59-yttrium
```
...
services:
  ...
  opera:
    image: selenium/node-opera:3.141.59-yttrium
    volumes:
      - /dev/shm:/dev/shm
    depends_on:
      - hub
...
$ docker run -d --link selenium-hub:hub -v /dev/shm:/dev/shm selenium/node-opera:3.141.59-yttrium
```
...
$ CH=$(docker run --rm --name=ch \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    -v /dev/shm:/dev/shm \
    selenium/node-opera:3.141.59-yttrium)
```
...
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub -v /dev/shm:/dev/shm selenium/node-opera-debug:3.141.59-yttrium
```
e.g.:
``` bash
...
$ docker run -d -P -p 5900:5900 --link selenium-hub:hub -v /dev/shm:/dev/shm selenium/node-opera-debug:3.141.59-yttrium
```
...
# OR
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 -v /dev/shm:/dev/shm selenium/standalone-opera-debug:3.141.59-yttrium
```
or
``` bash
...
# OR
$ docker run -d -p 4444:4444 -p 5900:5900 -v /dev/shm:/dev/shm selenium/standalone-opera-debug:3.141.59-yttrium
```
...
#FROM selenium/node-opera-debug:3.141.59-yttrium
